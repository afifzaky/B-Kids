...
export function ChildForgotUsername() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setError("");
    if (!parentEmail) { setError("Email orang tua wajib diisi"); return; }

    setIsLoading(true);
    try {
      const res = await fetch(`${API_BASE_URL}/api/auth/forgot-username`, {
        method: "POST",
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 sm:p-10">
          <div className="text-center mb-8">
            ...
            <p className="font-['Lato',sans-serif] text-gray-600 text-sm">
              Masukkan email orang tua. Username anak akan dikirim ke email tersebut.
            </p>
          </div>
            ...
            <div className="text-center space-y-5">
              ...
              <div>
                ...
                <p className="font-['Lato',sans-serif] text-gray-500 text-sm">
                  Jika email <span className="font-semibold text-bsi-orange-primary">{parentEmail}</span> terdaftar, daftar username anak akan dikirim dalam beberapa menit.
                </p>
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="email"
                      value={parentEmail}
                      onChange={(e) => { setParentEmail(e.target.value); if (error) setError(""); }}
